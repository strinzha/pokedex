    ...
    render() {
        return (
            <div className='App'>
                ...
                <PokemonList pokemons={this.state.pokemons} onLoadCharacteristics={this.handleLoadCharacteristics} onLoadMore={this.handleLoadMore}/> {this.state.characteristics.length !== 0
                    ? <PokemonCharacteristics characteristics={this.state.characteristics}/>
                    : null}
            </div>
        );
    },
